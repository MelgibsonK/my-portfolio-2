...
const SkillTag: React.FC<SkillTagProps> = ({ skillName }) => {
  ...
  return (
    ...
    <motion.span
      className="bg-mist-gray/10 text-antique-linen/80 py-1.5 px-4 rounded-full md:text-sm text-xs font-medium border border-burnt-brass/30 hover:border-burnt-brass hover:text-burnt-brass"
